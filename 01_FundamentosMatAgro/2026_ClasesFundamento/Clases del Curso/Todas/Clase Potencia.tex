...
\subtitle{Unidad 1: Operaciones algebraicas en lo reales\\ Clase 3: Potencias}
...
\begin{document}
	...
	% ----------------------------------------------------------
	\begin{frame}{Pregunta de salida (Exit Ticket)}
		
		\begin{block}{Antes de terminar la clase, responda brevemente}
			
			\begin{enumerate}
				
				\item Simplifique utilizando propiedades de potencias:
				...
				\item Explique con sus propias palabras:
				
				\textit{¿Qué representa el exponente en una potencia?}
				
				\pause
				
				\item En un cultivo experimental se utilizan \(3^4\) semillas por parcela.  
				Si el terreno tiene \(3^2\) parcelas, ¿cuántas semillas se utilizan en total?
		...
		\centering
		{\small \textcolor{WarmGray}{Este ejercicio permite verificar rápidamente la comprensión de la clase.}}
		
	\end{frame}
	
	% ----------------------------------------------------------
	\begin{frame}{Bibliografía y recursos para profundizar}
		
		\begin{block}{Bibliografía básica}
			
			\begin{itemize}
				
				\item Baldor, A. \textit{Álgebra}. Grupo Editorial Patria.
				
				\item Stewart, J., Redlin, L. \& Watson, S.  
				\textit{Precálculo: Matemáticas para el cálculo}. Cengage Learning.
				
				\item Larson, R. \textit{Precálculo}. Cengage Learning.
				
				\item OpenStax. \textit{Precalculus}. Rice University.
				
				\item Material de apoyo del curso  
				\textbf{Fundamentos de Matemática Básica}  
				Universidad Santo Tomás.
		...
		\begin{ideaBox}
			...
			El dominio de las \textbf{potencias} es fundamental para comprender:
			...
			\begin{itemize}
				...
				\item modelos de población
				
				\item cálculos en ciencias agronómicas
	...
	\begin{frame}{Ejercicios para practicar}
		...
		Resuelva utilizando las propiedades de las potencias.
	...
	% ----------------------------------------------------------
	\begin{frame}{Práctica contextualizada}
		
		\begin{block}{Aplicaciones en Agronomía}
			
			\begin{enumerate}
				
				\item En una parcela experimental se plantan \(4^3\) semillas por sector.  
				Si el terreno tiene \(4^2\) sectores, ¿cuántas semillas se plantan en total?
				
				\pause
				
				\item Una bacteria del suelo se duplica cada hora.  
				Si inicialmente hay \(2^3\) bacterias, ¿cuántas habrá después de 5 horas?
				
				\pause
				
				\item Un cultivo utiliza una densidad de \(3^4\) plantas por parcela.  
				Si hay \(3^2\) parcelas, ¿cuántas plantas se utilizan en total?
				
				\pause
				
				\item En un laboratorio agrícola cada caja contiene \(5^3\) muestras de suelo.  
				Si se almacenan \(5^2\) cajas, ¿cuántas muestras hay en total?
