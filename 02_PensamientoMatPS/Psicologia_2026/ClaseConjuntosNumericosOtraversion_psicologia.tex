...
% PALETA DE COLORES
% ==================================================
\definecolor{Primary}{HTML}{6D4C8B}
\definecolor{Secondary}{HTML}{9575CD}
\definecolor{Dark}{HTML}{2E2E2E}
\definecolor{SoftBg}{HTML}{F5F3FA}
\definecolor{TextDark}{HTML}{1E1E1E}
\definecolor{AccentA}{HTML}{C77DFF}
\definecolor{AccentB}{HTML}{80ED99}

% Colores auxiliares usados en TikZ
\definecolor{USTBlue}{HTML}{6D4C8B}
\definecolor{USTText}{HTML}{1E1E1E}
\definecolor{USTBlueDark}{HTML}{4A3560}

\setbeamercolor{normal text}{fg=TextDark,bg=white}
\setbeamercolor{structure}{fg=Primary}

% Título de diapositiva más claro y coherente
\setbeamercolor{frametitle}{bg=Primary!60,fg=black}
\setbeamercolor{title}{fg=white,bg=Primary}
\setbeamercolor{subtitle}{fg=white,bg=Secondary}

\setbeamercolor{block title}{bg=Primary!85,fg=white}
\setbeamercolor{block body}{bg=SoftBg,fg=TextDark}

\setbeamercolor{block title example}{bg=Secondary,fg=white}
\setbeamercolor{block body example}{bg=Secondary!10,fg=TextDark}

\setbeamercolor{block title alerted}{bg=Dark,fg=white}
\setbeamercolor{block body alerted}{bg=Dark!8,fg=TextDark}

\setbeamertemplate{frametitle}{
	\vspace{0.15cm}
	\begin{beamercolorbox}[sep=0.45em,left,wd=\paperwidth]{frametitle}
...
\setbeamertemplate{title page}{
	\begin{center}
		...
		{\color{Dark}\insertauthor\par}
		\vspace{0.2cm}
		{\color{Dark}\insertinstitute\par}
		\vspace{0.2cm}
		{\color{Dark}\insertdate\par}
		
		\vfill
		
		\begin{tikzpicture}
			\fill[Primary] (0,0) rectangle (3.8,0.28);
			\fill[Secondary] (3.8,0) rectangle (7.6,0.28);
			\fill[USTBlueDark] (7.6,0) rectangle (11.4,0.28);
		\end{tikzpicture}
	\end{center}
}
...
\newcommand{\vennbase}{
	\begin{tikzpicture}[scale=0.9]
		\draw[thick] (-2.8,-1.8) rectangle (2.8,1.8);
		\node at (-2.4,1.45) {$U$};
		\draw[thick] (-0.9,0) circle (1.2);
		\draw[thick] (0.9,0) circle (1.2);
		\node at (-1.5,1.4) {$A$};
		\node at (1.5,1.4) {$B$};
	\end{tikzpicture}
...
\newcommand{\vennunion}{
	\begin{tikzpicture}[scale=0.9]
		\draw[thick] (-2.8,-1.8) rectangle (2.8,1.8);
		\node at (-2.4,1.45) {$U$};
		\fill[Primary!30] (-0.9,0) circle (1.2);
		\fill[Primary!30] (0.9,0) circle (1.2);
		\draw[thick] (-0.9,0) circle (1.2);
		\draw[thick] (0.9,0) circle (1.2);
		\node at (-1.5,1.4) {$A$};
...
\newcommand{\venninter}{
	\begin{tikzpicture}[scale=0.9]
		...
		\node at (-2.4,1.45) {$U$};
		\begin{scope}
			\clip (-0.9,0) circle (1.2);
			\fill[Secondary!35] (0.9,0) circle (1.2);
		\end{scope}
		\draw[thick] (-0.9,0) circle (1.2);
		\draw[thick] (0.9,0) circle (1.2);
		\node at (-1.5,1.4) {$A$};
...
\newcommand{\venndiff}{
	\begin{tikzpicture}[scale=0.9]
		...
		\begin{scope}
			\clip (-0.9,0) circle (1.2);
			\fill[AccentA!35] (-0.9,0) circle (1.2);
			\fill[white] (0.9,0) circle (1.2);
		\end{scope}
		\draw[thick] (-0.9,0) circle (1.2);
		\draw[thick] (0.9,0) circle (1.2);
		\node at (-1.5,1.4) {$A$};
...
\newcommand{\venncomp}{
	\begin{tikzpicture}[scale=0.9]
		\fill[AccentB!30] (-2.8,-1.8) rectangle (2.8,1.8);
		\draw[thick] (-2.8,-1.8) rectangle (2.8,1.8);
		\node at (-2.4,1.45) {$U$};
...
\begin{document}
	...
	\begin{frame}{Resultado de Aprendizaje}
		\begin{enumerate}
			\item Resolver operatoria en los distintos conjuntos numéricos en situaciones vinculadas al análisis cuantitativo de contextos psicológicos.
		\end{enumerate}
	\end{frame}
	...
	\begin{frame}{Conjuntos Numéricos}
		...
		\begin{center}
			\begin{tikzpicture}[x=1.25cm,y=1cm,>=Latex]
				\draw[very thick,USTBlue,-{Latex[length=3mm]}] (-3.6,0) -- (3.6,0);
				\foreach \x/\lab in {-3/-3,-2/-2,-1/-1,0/0,1/1,2/2,3/3}{
					\draw[very thick,USTBlue] (\x,0.13) -- (\x,-0.13);
					\node[below,USTText] at (\x,-0.13) {\lab};
				}
			\end{tikzpicture}
		\end{center}
	\end{frame}
	...
	% ------------------------------------------------
	\begin{frame}{Conjuntos Numéricos}
		\begin{block}{Recta numérica}
			\begin{center}
				\begin{tikzpicture}[x=1.25cm,y=1cm,>=Latex]
					\draw[very thick,USTBlue,-{Latex[length=3mm]}] (-4,0) -- (4,0);
					\foreach \x/\lab in {-3/-3,-2/-2,-1/-1,0/0,1/1,2/2,3/3}{
						\draw[very thick,USTBlue] (\x,0.13) -- (\x,-0.13);
						\node[below,USTText] at (\x,-0.13) {\lab};
					}
	...
	% ------------------------------------------------
	\begin{frame}{Conjuntos Numéricos}\small{
		\begin{block}{Adición}
			Para sumar números enteros, debemos tener en cuenta que:
			
			\begin{enumerate}
				\item ``Si son del mismo signo, se suman los números y se conserva el signo''.
				
				\textbf{Ejemplos en contexto psicológico:}
				\begin{enumerate}
					\item Si una persona mejora $2$ puntos y luego mejora $5$ puntos más en una escala, el cambio total es:
					$
					2+5=7
					$
					
					\item Si una persona disminuye $4$ puntos y luego disminuye $7$ puntos más en un indicador:
					$
					-4+(-7)=-11
					$
					\pause
				...
				\item ``Si son de distinto signo, se restan los números y se conserva el signo del número mayor en valor absoluto''.
				\small{
				\textbf{Ejemplos en contexto psicológico:}
				\begin{enumerate}
					\item Si un puntaje sube $8$ puntos y luego baja $3$:
					$
					8+(-3)=5
					$
					
					\item Si un indicador emocional baja $10$ puntos y luego sube $9$:
					$
					-10+9=-1
					$
				\end{enumerate}
	...
	\begin{frame}{Conjuntos Numéricos}
		\begin{block}{Ejercicios}
			\textbf{Interpretación sugerida:} piense cada número como una variación en puntajes de bienestar, ansiedad, motivación o estado de ánimo.
	...
	\begin{frame}{Conjuntos Numéricos}
		\begin{block}{Multiplicación}
			...
			\begin{itemize}
				\item Al multiplicar dos números enteros de igual signo, el resultado es positivo $(+)$.
				\pause
				\item Al multiplicar dos números enteros de distinto signo, el resultado es negativo $(-)$.
				\pause
			\end{itemize}
	...
	\begin{frame}{Operatoria en los Números Racionales}
		\begin{block}{Adición}
			\small{Para sumar números racionales debemos tener en cuenta que:
			\pause
	...
	\begin{frame}{Actividad: Reconociendo Patrones}
		...
		%	¿Qué tienen en común estas expresiones? ¿Qué propiedades se están aplicando?
		%\end{alertblock}
	\end{frame}
	...
	\begin{frame}{Aplicaciones}
		\begin{enumerate}
			\small{
			\item Un psicólogo realiza un estudio sobre el estrés en 10 pacientes. Cada paciente reporta un nivel de estrés en una escala del 1 al 10. Los niveles reportados son los siguientes: 4, 5, 6, 3, 8, 7, 5, 6, 9 y 10. Pregunta: ¿Cuál es el promedio del índice de estrés de los pacientes?
			
			\item Un psicólogo mide la eficacia de un tratamiento en la reducción de la ansiedad, con los niveles de ansiedad antes y después del tratamiento para 5 pacientes.\\
			Niveles antes: 8, 7, 9, 6, 10\\
			Niveles después: 5, 4, 6, 3, 7\\
			¿Cuál es la reducción promedio de los niveles de ansiedad?
			
			\item Un psicólogo desea comparar los puntajes de dos pruebas de los pacientes. La media de la prueba A es 70 con una desviación estándar de 10, y un paciente obtiene 85. La media de la prueba B es 75 con una desviación estándar de 15, y el mismo paciente obtiene 90. Para calcular el puntaje Z para cada prueba se utiliza la fórmula:
			\[
			Z=\dfrac{X-\mu}{\sigma}
			\]
			donde $X$ es la puntuación obtenida, $\mu$ la media y $\sigma$ la desviación estándar. ¿Cuál es el puntaje Z del paciente en ambas pruebas?
		}
		\end{enumerate}
	\end{frame}
	...
	\begin{frame}[plain]
		\begin{tikzpicture}[remember picture,overlay]
			...
			\node[text=white,font=\bfseries\Huge] at (current page.center) {Gracias};
			\node[text=white!80,font=\large] at ([yshift=-1.1cm]current page.center) {Clase 7 -- Conjuntos Numéricos y Operatoria};
		\end{tikzpicture}
	\end{frame}
